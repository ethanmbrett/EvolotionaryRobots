    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for key in synapses:
            if key[1] == self.Get_Name():
                w = synapses[key].Get_Weight()
                v = neurons[key[0]].Get_Value()
                self.ALlow_Pre_Synaptic_Neuron_To_Influence_Me(w, v)
        self.Threshold()


    def ALlow_Pre_Synaptic_Neuron_To_Influence_Me(self, weight, value):
